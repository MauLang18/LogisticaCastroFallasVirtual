// ignore_for_file: file_names, avoid_unnecessary_containers, sized_box_for_whitespace, library_private_types_in_public_api, prefer_const_constructors
...
class _FormState extends State<Home2Page> {
  late Size size;
  List<dynamic>? dataS;
  String name = '';
  ...
  Future fetchName() async {
    ...
    response = await http.get(Uri.parse(
        'https://dynamicscf.azurewebsites.net/dynamics/listarClienteNombre?name=$codigo'));
