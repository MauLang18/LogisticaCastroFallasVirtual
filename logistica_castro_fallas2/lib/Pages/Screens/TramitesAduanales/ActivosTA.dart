...
class ActivosTA extends StatefulWidget {
  const ActivosTA({Key? key}) : super(key: key);
  Widget verticalSpace({double? space}) => SizedBox(height: space ?? 10.0);
  @override
  _FormState createState() => _FormState();
}

class _FormState extends State<ActivosTA> {
  List<dynamic>? dataA;
  List<dynamic>? dataS;
  String ship = '';
